/*
 * pcm051lb - phyCORE-AM335x Board Initalization Code
 *
 ...
 */
static int pcm051lb_console_init(void)
{
...
console_initcall(pcm051lb_console_init);

static int pcm051lb_mem_init(void)
{
...
mem_initcall(pcm051lb_mem_init);
...
static struct gpmc_config pcm051lb_nand_cfg = {
	.cfg = {
		0x00000800,	/* CONF1 */
		0x00030300,	/* CONF2 */
		0x00030300,	/* CONF3 */
...
static struct gpmc_nand_platform_data nand_plat = {
	...
	.nand_cfg = &pcm051lb_nand_cfg,
	.is_elm_used = 1,
};

static struct omap_barebox_part pcm051lb_barebox_part = {
	.nand_offset = SZ_512K,
	.nand_size = SZ_512K,
	.nor_offset = SZ_128K,
	.nor_size = SZ_512K,
...
static void pcm051lb_spi_init(void)
{
	...
	ret = spi_register_board_info(pcm051lb_spi_board_info,
					ARRAY_SIZE(pcm051lb_spi_board_info));
	am33xx_add_spi0();
}

static void pcm051lb_eth_init(void)
{
...
static void pcm051lb_i2c_init(void)
{
